...
public class RollerAgent : Agent
{
    ...
    [SerializeField] private Transform fount1;
    [SerializeField] private Transform fount2;
    ...
    [SerializeField] private bool isfount = false;
   ...
   public override void OnEpisodeBegin()
   {
       // print("Start");
        ...
        if (transform.localPosition.y < 0)
        {
            ...
            transform.localPosition = new Vector3(7, 0.5f, 22);
        }
        ...
        Target.localPosition = fount1.localPosition;
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
       ...
       // print("A");
        ...
        // Reached target
        if ((distanceToTarget < targetCol) && !isfount)
        {
            SetReward(6.0f);
            isfount = true;
            Target.localPosition = fount2.localPosition;
        }
        else if ((distanceToTarget < targetCol)&& isfount )
        {
            SetReward(6.0f);
            EndEpisode();
        }
